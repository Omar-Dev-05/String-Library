...

{
    ...
    cout << "Number of words: " <<
        clsString::CountWords("Omar Abobakr Mohammed") << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("Omar Abobakr", clsString::CapitalLetters)
        << endl << endl;
    ...
    String3.Value = "Omar Abobakr Mohammed";
    cout << "\n\nString     = " << String3.Value;
